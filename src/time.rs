...
pub fn get_current_date_string() -> String {
    ...
    format!("{0}-{1:0>2}-{2:0>2}, {3:0>2}:{4:0>2}:{5:0>2}", current_date.year, current_date.month, current_date.day, current_date.hour, current_date.minute, current_date.second)
}
